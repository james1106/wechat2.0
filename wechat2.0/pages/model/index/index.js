...
Page({
  ...
  getsubsidy: function () {
    wx.navigateTo({
        url: '../rank/subsidy/subsidy'
    })
  },
  getendurance: function () {
    wx.navigateTo({
        url: '../rank/mileage/mileage'
    })
  },
  getnew_car: function () {
    wx.navigateTo({
        url: '../rank/early/early'
    })
  },
  ...
  getchoose: function () {
    wx.navigateTo({
        url: '../search/condition/condition'
    })
  },
  ...
  gotoSeries: function (e) {
    ...
    //跳转到新页面，可返回
    wx.navigateTo({
      url: '../serie/serie?pinyin=' + data.pinyin + '&cityId=' + data.cityId + '&cityIdName=' + data.cityIdName
    })
  }
});
